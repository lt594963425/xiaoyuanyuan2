...
public class AvoidOnResult {
    ...
    private static AvoidOnResultFragment mAvoidOnResultFragment;
     ...
     * @param activity
     */
    public void AoR(Intent intent, Activity activity) {
        AvoidOnResult mAvoidOnResult = new AvoidOnResult(activity);
        mAvoidOnResult.startForResult(intent, 101, new AvoidOnResult.Callback() {
            @Override
