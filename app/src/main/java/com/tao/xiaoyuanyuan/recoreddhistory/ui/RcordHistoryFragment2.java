...
public class RcordHistoryFragment2 extends Fragment {
    ...
    public static RcordHistoryFragment2 newInstance() {
        return new RcordHistoryFragment2();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_hitory2, null);
...
//                });
        ...
        changeTv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                LiveDataBus.get().with("key1").postValue("");
            }
        });
        return view;
    }
