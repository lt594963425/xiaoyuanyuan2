 ...
 * Time: 下午 13:02
 */
public class MarqueeCTextView extends TextView {
        /** 默认滚动时间 */
        ...
        public MarqueeCTextView(Context context) {
            this(context, null);
        }

        public MarqueeCTextView(Context context, AttributeSet attrs) {
            this(context, attrs, 0);
        }

        public MarqueeCTextView(Context context, AttributeSet attrs, int defStyle) {
